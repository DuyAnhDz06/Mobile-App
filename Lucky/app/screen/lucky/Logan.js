            ...
            <View>
                ...
                <View style={{ marginTop: 15, justifyContent: 'center' }}>
                    ...
                    <View style={{ marginLeft: 5, marginTop: 10 }}>
                        <Image
                            source={require('@app/assets/images/Bac.png')}
                            style={{ width: '100%', height: 200 }}
                        ></Image>
                    </View>
                    <TouchableOpacity style={{ justifyContent: 'center', backgroundColor: 'green', marginHorizontal: 40, marginTop: 20, borderRadius: 5, paddingVertical: 10 }}>
