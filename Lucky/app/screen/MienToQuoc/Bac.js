    ...
    <ScrollView>
      <View>
            ...
            return (
              <View
                style={{
                  ...
                  borderBottomWidth: 1,
                  borderColor: '#EEEEEE',
                  backgroundColor: i.rank % 2 != 0 || i.rank == 'MaDb' ? '#F8F8FF' : '#fff',
                  shadowColor: 'red',
        ...
        <View style={{flexDirection: 'row', alignItems: 'center', marginTop: 15}}>
          ...
          <View>
            <Text style={{width: 70, textAlign: 'center', color: colors.grey3}}>Banner</Text>
          </View>
          <View style={{flex: 1, height: 1, backgroundColor: colors.grey3}} />
        </View>
        <View style={{marginTop: 15, justifyContent: 'center'}}>
          <Text style={{fontSize: 20, color: colors.grey1, marginLeft: 5}}>Banner</Text>
